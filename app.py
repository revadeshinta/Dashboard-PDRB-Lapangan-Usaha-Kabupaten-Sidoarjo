...
# =========================
st.caption(
    "Sumber: Badan Pusat Statistik (BPS) Kabupaten Sidoarjo. "
    "Data diolah oleh Reva Deshinta Isyana, mahasiswa S-1 Sains Data "
    "Universitas Negeri Surabaya, sebagai mini proyek magang."
)
